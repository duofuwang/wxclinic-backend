...
public class CodeGenerator {
     ...
     * 生成的位置
     */
    private static final String PACKAGE_PATH = "com.dopoiv.clinic.project";

    private static final String SUPER_ENTITY_PATH = "com.dopoiv.clinic.common.tools.BaseEntity";

    private static final String SUPER_CONTROLLER_PATH = "com.dopoiv.clinic.common.tools.BaseController";
